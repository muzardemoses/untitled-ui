    ...
    <div class="pt-8 px-8 pb-12 flex flex-col gap-8 flex-grow">
      <div class="flex justify-between">
        ...
        <div class="flex gap-3">
          <WhiteButtonVue class="h-10 w-28 text-gray-700 font-semibold text-sm"
            >$ Deposit
          </WhiteButtonVue>
      ...
      >
        <div class="flex flex-col gap-3.5">
          ...
          <div class="flex gap-4 items-center">
            <h3 class="text-gray-900 text-3xl font-semibold">$107,843.82</h3>
            <p
        ...
        <h3 class="font-semibold text-gray-900 text-lg">Balance over time</h3>
